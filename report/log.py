...
from report.models import Person, BotRun, Bot, Domain, Log, Property
...
def get_or_create_bot_run(bot, run_id, run_name, started=None, ended=None, domain=None):
    if not started:
...
def process_log(file_path):
    ...
    bot_run = get_or_create_bot_run(bot, metadata['run_id'], metadata['run_name'], domain=metadata['domain'])
